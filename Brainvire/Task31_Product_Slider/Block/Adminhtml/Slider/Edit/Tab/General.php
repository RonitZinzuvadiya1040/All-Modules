...
namespace Brainvire\Task31_Product_Slider\Block\Adminhtml\Slider\Edit\Tab;

use Brainvire\Task31_Product_Slider\Block\Adminhtml\Slider\Edit\Tab\Renderer\Category;
use Brainvire\Task31_Product_Slider\Model\Config\Source\Location;
use Brainvire\Task31_Product_Slider\Model\Config\Source\ProductType;
use Brainvire\Task31_Product_Slider\Model\ResourceModel\SliderFactory;
use Brainvire\Task31_Product_Slider\Model\Slider;
...
class General extends Generic implements TabInterface {
	...
	protected function _prepareForm() {
		/** @var Slider $slider */
		$slider = $this->_coreRegistry->registry('brainvire_task31_product_slider');
